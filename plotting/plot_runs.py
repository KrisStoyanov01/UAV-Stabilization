...
def plot_experiment(experiment, logdir):
    ...
    if PLOT_TYPE == "ratio":
        ...
        axs.set_ylabel("Training-time Violations", fontsize=42)
    elif PLOT_TYPE == "PR":
        axs.set_ylabel("Task Successes", fontsize=42)
        axs.set_xlabel("Constraint Violations", fontsize=42)
    elif PLOT_TYPE == "reward":
        axs.set_xticks([0, 500, 1000, 1500, 2000])
        axs.set_ylim(-0.1, 2500)
    ...
    for alg in experiment_map["algs"]:
        ...
        for fname in fnames:
            ...
            print(fname, task_successes.shape)
        ...
        if PLOT_TYPE == "ratio":
            ...
            axs.plot(safe_ratios_mean, color=get_color(alg), linewidth=4)
        elif PLOT_TYPE == "success":
            axs.fill_between(
            ...
            axs.plot(ts_mean, color=get_color(alg), linewidth=4)
        elif PLOT_TYPE == "violation":
            axs.fill_between(
            ...
            axs.plot(tv_mean, color=get_color(alg), linewidth=4)
        elif PLOT_TYPE == "PR":
            axs.errorbar(
            ...
            axs.plot(trew_mean, color=get_color(alg), linewidth=4)
        else:
            raise NotImplementedError("Unsupported Plot Type")
    ...
    PATH = experiment + "_" + PLOT_TYPE + ".png"
    fig.savefig(PATH, bbox_inches='tight', dpi=300)
    plt.show()


if __name__ == "__main__":
    experiment = "kine_car"  # ** insert experiment name here **
    logdir = "/home/shaohang/Study/reinforcement_learning/safe_rl/records/plots/car/plotting" # ** insert logdir here **
    # logdir = "/home/shaohang/Dropbox/reading/saved_model/training_process_drone"
