...
def get_args():
    ...
    parser.add_argument('--warm_start_num',
                        type=int,
                        default=500,
                        help='warm start num')
    ...
    ################### Comparisons ###################
    # LAC
    parser.add_argument('--LBAC', action='store_true', help='Use LBAC')
    parser.add_argument('--lambda_LBAC',
                        type=float,
                        default=0.01,
                        help='penalty term for LBAC (default: 0.01)')
    # RP
    parser.add_argument(
